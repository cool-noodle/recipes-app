                    ...
                    <div className='px-8'>
                        ...
                        <article className='bg-rose-50 mt-6 p-5 rounded-xl'>
                            <div className='flex justify-between items-center'>
                                ...
                                {item?.more.source && <a href={item?.more.source} target='_blank'><BsFillQuestionCircleFill className='size-7 text-rose-200 cursor-pointer' /></a>}
                            </div>
                            <ul className='list-disc mt-3 mr-8 marker:text-orange-500'>
                                ...
                                <li className='pr-2 mt-3'>
                                    <p>
                                        <span className='font-medium'>זמן הכנה: </span><span>{`${item?.more.prep_time} דקות`}</span>
                                    </p>
                                </li>
                                <li className='pr-2 mt-3'>
                                    <p>
                                        <span className='font-medium'>זמן בישול / אפייה: </span><span>{`${item?.more.cook_time} דקות`}</span>
                                    </p>
                                </li>
                            </ul>
